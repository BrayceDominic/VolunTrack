...
import { View, Text, StyleSheet, FlatList, ScrollView, Linking, Button } from 'react-native';
...
const faqData = [
  ...
  // { id: '2', question: 'How do I add a volunteer?', answer: 'Navigate to the Volunteers tab and click "Add Volunteer." Fill out the required information.' },
  { id: '3', question: 'How do I view my tasks?', answer: 'After you have succesfully logged in your dashboard will display your assigned tasks on a special project card.' },
...
const howToGuides = [
  ...
  // { id: '3', title: 'How to Track Attendance', guide: 'Supervisors can go to the Attendance tab > Select project > View attendance.' },
  { id: '4', title: 'How to Submit Feedback', guide: 'Volunteers can use the Feedback form on their feedback screen to send feedback to supervisors.' },
...
const App = () => {
  const openLink = (url) => Linking.openURL(url).catch(err => console.error('Error opening URL:', err));
  const openLiveChat = () => alert('Live chat feature coming soon!');
  const navigateToReportPage = () => alert('Redirecting to report issue page...');
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Button title="Live Chat" onPress={openLiveChat} color="#004158" />
